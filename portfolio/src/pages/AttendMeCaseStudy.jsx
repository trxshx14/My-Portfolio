...
export default function AttendMeCaseStudy() {
  return (
    <CaseStudyShell title="AttendMe">
      {/* ---------- hero ---------- */}
      <div className="cs-hero">
        <SectionLabel>Case Study</SectionLabel>
        <h1>
          AttendMe — <em>attendance, designed</em> for schools
        </h1>
        <p className="cs-lede">
          A web and mobile attendance management system that lets teachers record a full class in
          under a minute and gives administrators real-time, exportable visibility — built with
        ...
        <div className="cs-roles">
          ...
          <StatusPill>Backend Developer</StatusPill>
          <StatusPill>Mobile Developer</StatusPill>
          <StatusPill>Database Designer</StatusPill>
        </div>
        <CSImage src="/images/attendme-dashboard.png" alt="AttendMe admin dashboard" />
      </div>
      ...
      <Section num={1} label="Project Overview">
        ...
        <P>
          AttendMe replaces paper rosters and scattered spreadsheets with a centralized attendance
          platform for schools. Teachers record attendance from any device in seconds;
          administrators monitor school-wide trends, manage users, and export reports. The system
          supports two strictly separated roles — <Highlight>Teachers</Highlight> and{" "}
          <Highlight>Administrators</Highlight> — enforced through JWT authentication and
          role-based access control on both the client and the API.
        </P>
      </Section>
      ...
      <Section num={2} label="Problem Statement">
        ...
        <P>
          Manual attendance tracking is slow, error-prone, and impossible to audit. Teachers lose
          the first minutes of every class to roll call; administrators only discover attendance
          problems weeks later when records are compiled; and handwritten marks can be lost or
          altered without a trace.
        </P>
        <P>
          <Highlight>The core question:</Highlight> How might we make recording attendance fast
          enough to happen mid-class, while giving administrators trustworthy, real-time data they
          can act on?
        </P>
      </Section>
      ...
      <Section num={4} label="Target Users">
        ...
        <div className="cs-duo">
          <div className="cs-duo-card">
            <h3>Teachers</h3>
            <p>
              Recording attendance at the start of class, often on a phone, under time pressure.
              They need speed, minimal taps, and quick corrections.
            </p>
          </div>
          <div className="cs-duo-card">
            <h3>Administrators</h3>
            <p>
              Reviewing attendance across sections from a desktop. They need trends, exception
              flags, exportable reports, and user management.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section num={6} label="Research & Analysis">
        ...
        <Bullets
          items={[
            <span key="1">
              <Highlight>Speed beats features.</Highlight> Instructors said anything slower than
              calling roll would not be adopted. This drove the "default everyone to Present, mark
              only exceptions" interaction pattern.
            </span>,
            <span key="2">
              <Highlight>Late and Excused are policy-critical.</Highlight> Binary present/absent
              tools force teachers to keep side notes — four states had to be first-class in both
              the data model and the UI.
            </span>,
            <span key="3">
              <Highlight>Admins think in trends, not rows.</Highlight> Raw tables alone weren't
              useful; they wanted at-a-glance percentages, flagged students, and comparisons across
              sections.
            </span>,
          ]}
        />
        <P>
          A competitive scan showed most existing tools were either bloated school ERPs or overly
          simple binary check-in apps, confirming a gap for a focused, role-aware system.
        </P>
        <CSImage
      ...
      <Section num={7} label="User Flow">
        ...
        <P>
          <Highlight>Teacher:</Highlight> Login → Dashboard → Select class session → roster loads
          with everyone defaulted to <em>Present</em> → tap exceptions (Absent / Late / Excused) →
          Save → confirmation with summary count.
        </P>
        <P>
          <Highlight>Administrator:</Highlight> Login → Admin Dashboard → school-wide analytics →
          drill into a section or student → export report → manage users (create teacher accounts,
          assign sections).
        </P>
        <CSImage
      ...
      <Section num={9} label="Wireframes">
        ...
        />
        <CSImage src="/images/attendme-lofi.png" alt="AttendMe lo-fi wireframes" />
        <CSImage
          src="/images/attendme-midfi-teacher.png"
          alt="AttendMe mid-fidelity teacher screens"
        />
        <CSImage src="/images/attendme-dashboard.png" alt="AttendMe admin dashboard" />
      </Section>
      ...
      <Section num={10} label="Visual Design Decisions">
        ...
        />
        <CSImage src="/images/attendme-styleguide.png" alt="AttendMe style guide" />
      </Section>
      ...
      <Section num={11} label="Key Features">
        ...
        <Bullets
          items={[
            <span key="1">
              <Highlight>JWT Authentication</Highlight> — stateless, token-based sessions for both
              web and mobile clients.
            </span>,
            <span key="2">
              <Highlight>Role-Based Access Control</Highlight> — teachers see only their sections;
              admins manage users and view all data. Enforced at both the route and API level.
            </span>,
            <span key="3">
              <Highlight>Four-State Recording</Highlight> — Present, Absent, Late, Excused, with
              bulk "all present" defaulting and per-student exception toggles.
            </span>,
            <span key="4">
              <Highlight>Attendance History</Highlight> — complete per-student and per-section
              timelines with date filtering.
            </span>,
            <span key="5">
              <Highlight>Reports & Analytics</Highlight> — attendance percentages, trend charts,
              and exception flags per section and student.
            </span>,
            <span key="6">
              <Highlight>User Management</Highlight> — admin-controlled account creation, role
              assignment, and deactivation.
            </span>,
            <span key="7">
              <Highlight>Report Export</Highlight> — downloadable reports for offline distribution
              and record-keeping.
            </span>,
          ]}
        />
        <CSImage src="/images/attendme-teacher.png" alt="AttendMe teacher roster screen" />
      </Section>
      ...
      <Section num={14} label="Responsive Design Considerations">
        ...
        />
        <CSImage src="/images/attendme-responsive.png" alt="AttendMe responsive design" />
      </Section>
      ...
      <Section num={16} label="Lessons Learned">
        ...
        <Bullets
          items={[
            <span key="1">
              <Highlight>Design the API contract first.</Highlight> The few times we skipped this,
              frontend and backend assumptions drifted and cost debugging time.
            </span>,
            <span key="2">
              <Highlight>The fastest UI has the fewest decisions.</Highlight> Defaulting to Present
              and marking exceptions was the single highest-impact design choice in the project.
            </span>,
            <span key="3">
              <Highlight>RBAC must live on the server.</Highlight> Hiding buttons is UX; rejecting
              unauthorized requests is security. They're two different jobs.
            </span>,
            <span key="4">
              <Highlight>Database design is UX design.</Highlight> The append-only attendance model
              came from a user need — trustworthy records — not a technical preference. Schema
              decisions shaped what the interface could promise users.
            </span>,
          ]}
        />
      </Section>
      ...
      <CTAFooter
        message="Thanks for reading! Explore the project:"
        demo="https://attendme-frontend.onrender.com/login"
        source="https://github.com/trxshx14/IT342-Cararag-AttendMe"
      />
    </CaseStudyShell>
  );
}