...
/* ============================================================
   Cozy Pomodoro Case Study — full-screen overlay
    ...
    <div style={{ background: "#0F0C1B", minHeight: "100vh", fontFamily: "'Inter', 'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 10, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 28px", background: "rgba(15,12,27,0.92)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(226,164,196,0.1)" }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: TEXT }}>
          <span style={{ color: PINK }}>Cozy Pomodoro</span>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 28px 96px" }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          >
            ...
            >
              Calm focus, zero anxiety
            </span>{" "}
            for burnt-out minds
          </h1>
          <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.75, marginBottom: 20, maxWidth: 600 }}>
            An ambient pomodoro timer that transforms productivity into a calming ritual, featuring a pixel cat companion,
            lo-fi ambient audio, soft pastel themes, and a session tracker that rewards consistency without pressure. Built
            with React and the Web Audio API.
          </p>
          <div style={{ marginBottom: 18 }}>
            <StatusPill color={PINK}>UI/UX Designer</StatusPill>
            <StatusPill color={PINK}>Frontend Developer</StatusPill>
            <StatusPill color={PINK}>Interaction Designer</StatusPill>
            <StatusPill color={PINK}>Motion Designer</StatusPill>
            <StatusPill color={PINK}>Audio Systems</StatusPill>
          </div>
          <img
            src="/images/cozy-dashboard.png"
            alt="Cozy Pomodoro main timer interface"
            style={{
              width: "100%",
              borderRadius: 14,
        ...
        <Section num={1} label="Project Overview">
          ...
          <P>
            Cozy Pomodoro reimagines the traditional pomodoro method as a gentle, ambient experience rather than a rigid
            countdown clock. A pixel cat companion keeps you company through focus sessions and naps through breaks; a
            bubble tea fills as you work; and a context-aware window shows you whether it's sunrise, golden hour, or a
            cozy night outside. The app supports three modes: {" "}
            <Highlight>Focus</Highlight>,{" "}
            <Highlight>Short Break</Highlight>, and{" "}
            <Highlight>Long Break</Highlight> each with its own colour palette, ambient soundscape, and animated scene,
            so switching modes feels like a mood shift, not an alarm.
          </P>
        </Section>
        ...
        <Section num={2} label="Problem Statement">
          ...
          <P>
            Traditional productivity timers are built around urgency: loud alarms, stark interfaces, relentless countdowns.
            For students and remote workers already prone to digital fatigue, these apps amplify the very stress they
            promise to manage. The result is timer anxiety, users avoid starting sessions because the act of starting
            feels punishing.
          </P>
          <P>
            <Highlight>The core question:</Highlight> How might we design a pomodoro timer that motivates focus through
            comfort rather than pressure, while still keeping users honest about how they're spending their time?
          </P>
        </Section>
        ...
        <Section num={4} label="Target Users">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 8 }}>
            <div style={{ background: "rgba(30,24,51,0.5)", border: "1px solid rgba(226,164,196,0.12)", borderRadius: 14, padding: 18 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: TEXT, marginBottom: 6 }}> Students</div>
              <div style={{ fontSize: 12.5, color: MUTED, lineHeight: 1.7 }}>
                Studying for exams or working through coursework, often late at night. They need something cozy enough to
                keep them at their desk without tipping into dread. The pixel cat is their study buddy.
              </div>
            </div>
            <div style={{ background: "rgba(30,24,51,0.5)", border: "1px solid rgba(226,164,196,0.12)", borderRadius: 14, padding: 18 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: TEXT, marginBottom: 6 }}>Remote Workers</div>
              <div style={{ fontSize: 12.5, color: MUTED, lineHeight: 1.7 }}>
                Context-switching all day across Slack, Notion, and video calls. They need a ritual that signals "deep
                work starts now" without adding cognitive overhead. The ambient audio and mood shift do the signalling.
              </div>
            </div>
          </div>
        </Section>
        ...
        <Section num={6} label="Research & Analysis">
          ...
          <Bullets
            items={[
              <span key="1">
                <Highlight>Ritual matters more than rigidity.</Highlight> Users who stuck with pomodoro long-term described
                it as a habit with texture, a specific playlist, a specific drink, a specific spot. Cozy Pomodoro builds
                that texture into the interface itself.
              </span>,
              <span key="2">
                <Highlight>Breaks need to feel different, not just shorter.</Highlight> A timer that looks identical in
                focus and break mode gives the brain no signal to actually rest. Distinct colour palettes and the cat
                switching from studying to napping create a genuine mode shift.
              </span>,
              <span key="3">
                <Highlight>Gentle progress beats aggressive gamification.</Highlight> Streaks and badges create anxiety
                when broken. Paw-print session counters that fill quietly, with no reset penalty, keep motivation
                intrinsic rather than performative.
              </span>,
            ]}
          />
          <P>
            A scan of existing tools (Forest, Be Focused, Pomofocus, Tide) confirmed a gap: apps are either feature-dense
            and clinical, or minimal to the point of offering no atmosphere. None offered a cohesive ambient experience
            with personalisation that didn't require a subscription.
          </P>
          <img
            src="/images/cozy-research.png"
        ...
        <Section num={7} label="User Flow">
          ...
          <P>
            <Highlight>Starting a session:</Highlight> Land on the timer → ambient audio auto-suggests based on time of
            day → select a focus goal from the scratchpad → press Start → cat shifts from idle to studying → bubble tea
            begins to fill → timer ends with a soft chime → cat rewards itself with a sip.
          </P>
          <P>
            <Highlight>Customising the environment:</Highlight> Open Settings drawer → adjust session/break durations →
            pick a tea flavour → dress the cat from the wardrobe → dial ambient sound levels → close drawer and the
            change is immediate, no reload.
          </P>
          <img
            src="/images/cozy-user-flow.png"
            alt="Cozy Pomodoro user flow diagram"
            loading="lazy"
            style={{
              width: "100%",
              borderRadius: 14,
        ...
        <Section num={9} label="Wireframes">
          ...
          <img
            src="/images/cozy-dashboard.png"
            alt="Cozy Pomodoro mid-fidelity wireframes"
            loading="lazy"
            style={{
              width: "100%",
              borderRadius: 14,
          ...
          />
          <img
            src="/images/cozy-hifi.png"
            alt="Cozy Pomodoro high-fidelity screens"
            loading="lazy"
            style={{
              width: "100%",
              borderRadius: 14,
        ...
        <Section num={10} label="Visual Design Decisions">
          ...
          <Bullets
            items={[
              ...
              "All interactive elements meet minimum 44px touch targets; animations respect prefers-reduced-motion system preference.",
            ]}
          />
          <img
            src="/images/cozy-dashboard.png"
            alt="Cozy Pomodoro style guide — colour, type, and components"
            loading="lazy"
            style={{
              width: "100%",
              borderRadius: 14,
        ...
        <Section num={11} label="Key Features">
          ...
          <Bullets
            items={[
              <span key="1"><Highlight>Pixel Cat Companion</Highlight> — studies during focus, naps on a pillow during breaks, and wakes up with a full animation sequence when the break ends. Dressable via the wardrobe (glasses, cozy hat, pink bow).</span>,
              <span key="2"><Highlight>Three Ambient Modes</Highlight> — Focus (blush), Short Break (sage), and Long Break (lavender), each with distinct colour systems, pixel scenes, and character states that transition smoothly.</span>,
              <span key="3"><Highlight>Bubble Tea Progress Indicator</Highlight> — fills as you focus, reveals boba pearls at 50% completion, pops a straw when the session ends. Three flavours: strawberry, matcha, taro.</span>,
              <span key="4"><Highlight>Ambient Audio Engine</Highlight> — Web Audio API synthesised rain, café murmur, and lo-fi chord drone, each independently volume-controlled in the settings drawer.</span>,
              <span key="5"><Highlight>Context-Aware Window</Highlight> — a painted scene outside your virtual window that reads the system clock and renders sunrise, midday, twilight, or night with corresponding sky gradients, hills, and stars.</span>,
              <span key="6"><Highlight>Focus Goals Scratchpad</Highlight> — lightweight task list with sparkle-burst completion animations; no sync, no account, no pressure.</span>,
              <span key="7"><Highlight>Breathing Guide</Highlight> — a full-screen pulsing orb with particle ring for between-session resets; dismissible with Escape.</span>,
            ]}
          />
          <img
            src="/images/cozy-features.png"
            alt="Cozy Pomodoro feature overview"
            loading="lazy"
            style={{
              width: "100%",
              borderRadius: 14,
        ...
        <Section num={14} label="Responsive Design Considerations">
          ...
          <Bullets
            items={[
              "Two-column gird: Timer card sits left, window scene and task panel sit right. Below the lg breakpoint the columns stack, timer on top, goals below.",
        ...
        <Section num={16} label="Lessons Learned">
          ...
          <Bullets
            items={[
              <span key="1"><Highlight>Micro-narrative is UX.</Highlight> The cat drinking bubble tea at session end is functionally identical to a green checkmark — but one creates a moment worth waiting for. Delight is a retention strategy.</span>,
              <span key="2"><Highlight>Animation state machines beat ad-hoc booleans.</Highlight> The wake-up sequence taught me to model multi-step animations as a named phase string (mask → eyes → wide → sitting) rather than stacking isXDone flags that interact unpredictably.</span>,
              <span key="3"><Highlight>Audio is a first-class design material.</Highlight> The ambient engine was scoped in late and took proportionally longer to integrate cleanly than any visual feature. Next time it goes in the architecture from day one.</span>,
              <span key="4"><Highlight>No-account apps require deliberate state design.</Highlight> When localStorage is your only persistence layer, every piece of state that survives a reload must be a conscious choice, not an afterthought when users complain about losing streaks.</span>,
            ]}
          />
        </Section>
        ...
        <div style={{ borderTop: "1px solid rgba(226,164,196,0.1)", paddingTop: 32, textAlign: "center" }}>
          <p style={{ fontSize: 14, color: MUTED, marginBottom: 20 }}>Thanks for reading! Try it yourself:</p>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <a
              href="https://cozypomodoro-by-trishadev.vercel.app/"
              target="_blank"
              rel="noreferrer"
              style={{
                background: `linear-gradient(135deg, ${PINK}, ${MAUVE})`,
            ...
            <a
              href="https://github.com/trxshx14/CozyPomodoro.git"
              target="_blank"
              rel="noreferrer"
              style={{
